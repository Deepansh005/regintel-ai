    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] text-slate-900 selection:bg-violet-200 font-sans relative overflow-hidden flex flex-col items-center justify-center p-6">
            ...
            <div className="absolute top-6 right-6 z-20">
                <div className="bg-white/80 backdrop-blur-md border border-slate-200 px-4 py-2 rounded-full flex items-center gap-3 shadow-sm">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                    <span className="text-xs font-bold text-slate-600 uppercase tracking-wider">Demo Ready: Use files from /demo folder</span>
                </div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-4xl">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <button 
                        ...
                        className="group text-left bg-white/70 backdrop-blur-xl border border-slate-200 rounded-[2.5rem] p-10 hover:shadow-[0_40px_80px_-20px_rgba(124,58,237,0.15)] hover:-translate-y-2 hover:border-violet-300 transition-all duration-500 relative overflow-hidden"
                    >
                        ...
                        <div className="w-16 h-16 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-center mb-8 group-hover:bg-violet-500 group-hover:border-violet-500 transition-colors shadow-sm relative z-10">
                            <FileText className="w-8 h-8 text-slate-400 group-hover:text-white transition-colors" />
                        </div>
                        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 mb-4 relative z-10">Old Regulation Analysis</h2>
                        ...
                        <div className="flex items-center gap-2 text-sm font-bold text-violet-600 uppercase tracking-widest group-hover:gap-4 transition-all relative z-10">
                    ...
                    <button 
                        ...
                        className="group text-left bg-white/70 backdrop-blur-xl border border-slate-200 rounded-[2.5rem] p-10 hover:shadow-[0_40px_80px_-20px_rgba(14,165,233,0.15)] hover:-translate-y-2 hover:border-blue-300 transition-all duration-500 relative overflow-hidden"
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        <div className="w-16 h-16 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-center mb-8 group-hover:bg-blue-500 group-hover:border-blue-500 transition-colors shadow-sm relative z-10">
                            <CheckCircle2 className="w-8 h-8 text-slate-400 group-hover:text-white transition-colors" />
                        </div>
                        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 mb-4 relative z-10">New Regulation Update</h2>
                        <p className="text-slate-500 font-medium leading-relaxed mb-10 relative z-10">
                        ...
                        <div className="flex items-center gap-2 text-sm font-bold text-blue-600 uppercase tracking-widest group-hover:gap-4 transition-all relative z-10">
                            Initialize Engine <ArrowRight className="w-4 h-4" />
                        </div>
                    </button>
                </div>
